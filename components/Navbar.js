...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-20 shadow-xl z-[100] px-2 2xl:px-16">
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Image src="/assets/logov1.png" alt="logo" width={125} height={50} />
        <div>
      ...
      >
        <div
          className={
            nav
              ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#efc0f3] p-10 ease-in duration-500'
